...
- [x] `0.1.2` artifact built and installed. (deterministic SHA `29c1d05b...fd9e`, install-dir SHA256SUMS clean)
...
| C7 - Deterministic Build & Install | done | Two consecutive builds produce identical bundle SHA `29c1d05bc30f570373d09a2ebb38313bda8466d4faa31e70a2e865e1c046fd9e`. Install-dir `SHA256SUMS` verifies clean. Verifier 9/9, acceptance 21/21, regression 96 passed. |
