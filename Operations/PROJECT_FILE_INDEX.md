...
| `plans/m365-authoritative-persona-census-and-department-model-decision/m365-authoritative-persona-census-and-department-model-decision.md` | Draft H1 child plan for locking the `39 -> 59` census contract and proving whether all `20` extras fit inside the current `10`-department model. | `Mission Statement`, `Core Success Metrics` | `plan:m365-authoritative-persona-census-and-department-model-decision:R1` |
| `plans/m365-authoritative-persona-census-and-department-model-decision/m365-authoritative-persona-census-and-department-model-decision.yaml` | Structured YAML authority for the draft H1 census and department-model decision phase. | `Technical Architecture`, `Core Success Metrics` | `plan:m365-authoritative-persona-census-and-department-model-decision:R1` |
| `plans/m365-authoritative-persona-census-and-department-model-decision/m365-authoritative-persona-census-and-department-model-decision.json` | Structured JSON mirror for the draft H1 census and department-model decision phase. | `Technical Architecture`, `Core Success Metrics` | `plan:m365-authoritative-persona-census-and-department-model-decision:R1` |
| `docs/prompts/codex-m365-authoritative-persona-census-and-department-model-decision.md` | Detailed prompt for executing the H1 authoritative census and department-model decision phase after approval. | `Policy & Security`, `Technical Architecture` | `plan:m365-authoritative-persona-census-and-department-model-decision:R1` |
| `docs/prompts/codex-m365-authoritative-persona-census-and-department-model-decision-prompt.txt` | Kickoff prompt for the draft H1 authoritative census and department-model decision phase. | `Policy & Security`, `Technical Architecture` | `plan:m365-authoritative-persona-census-and-department-model-decision:R1` |
