...
| `plans/m365-token-provider-runtime-repair/m365-token-provider-runtime-repair.md` | P3A child plan normalized to the current master structure for the bounded M365 service-auth/runtime repair path. Draft until approved. | `Technical Architecture` | `plan:m365-token-provider-runtime-repair:R1` |
| `plans/m365-token-provider-runtime-repair/m365-token-provider-runtime-repair.yaml` | Structured YAML authority for the normalized P3A bounded M365 service-auth/runtime repair phase. | `Technical Architecture` | `plan:m365-token-provider-runtime-repair:R1` |
| `plans/m365-token-provider-runtime-repair/m365-token-provider-runtime-repair.json` | Structured JSON authority mirroring the normalized P3A bounded M365 service-auth/runtime repair phase. | `Technical Architecture` | `plan:m365-token-provider-runtime-repair:R1` |
