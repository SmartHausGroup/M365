...
| `plans/m365-token-provider-runtime-repair/m365-token-provider-runtime-repair.md` | P3A child plan for the bounded M365 service-auth/runtime repair path, now blocked after execution proved the remaining defect is sibling UCP caller alignment. | `Technical Architecture` | `plan:m365-token-provider-runtime-repair:R1` |
| `plans/m365-token-provider-runtime-repair/m365-token-provider-runtime-repair.yaml` | Structured YAML authority for the P3A bounded M365 service-auth/runtime repair phase and its blocked execution outcome. | `Technical Architecture` | `plan:m365-token-provider-runtime-repair:R1` |
| `plans/m365-token-provider-runtime-repair/m365-token-provider-runtime-repair.json` | Structured JSON authority mirroring the P3A bounded M365 service-auth/runtime repair phase and its blocked execution outcome. | `Technical Architecture` | `plan:m365-token-provider-runtime-repair:R1` |
