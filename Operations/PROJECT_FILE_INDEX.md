...
| `plans/m365-authoritative-persona-certification-and-count-rebase/m365-authoritative-persona-certification-and-count-rebase.md` | Draft H4 child plan for rebasing certification and count truth to the post-H3 staged authoritative state before final activation. | `Mission Statement`, `Core Success Metrics` | `plan:m365-authoritative-persona-certification-and-count-rebase:R1` |
| `plans/m365-authoritative-persona-certification-and-count-rebase/m365-authoritative-persona-certification-and-count-rebase.yaml` | Structured YAML authority for the draft H4 certification and count rebase phase. | `Technical Architecture`, `Core Success Metrics` | `plan:m365-authoritative-persona-certification-and-count-rebase:R1` |
| `plans/m365-authoritative-persona-certification-and-count-rebase/m365-authoritative-persona-certification-and-count-rebase.json` | Structured JSON mirror for the draft H4 certification and count rebase phase. | `Technical Architecture`, `Core Success Metrics` | `plan:m365-authoritative-persona-certification-and-count-rebase:R1` |
| `docs/prompts/codex-m365-authoritative-persona-certification-and-count-rebase.md` | Detailed prompt for executing the H4 notebook-first certification and count rebase phase after approval. | `Policy & Security`, `Technical Architecture` | `plan:m365-authoritative-persona-certification-and-count-rebase:R1` |
| `docs/prompts/codex-m365-authoritative-persona-certification-and-count-rebase-prompt.txt` | Kickoff prompt for the draft H4 certification and count rebase phase. | `Policy & Security`, `Technical Architecture` | `plan:m365-authoritative-persona-certification-and-count-rebase:R1` |
