...
| `plans/m365-authoritative-persona-registry-and-capability-map-rebase/m365-authoritative-persona-registry-and-capability-map-rebase.md` | Draft H3 child plan for rebasing the authoritative roster, persona registry, and capability map to the 59-persona truth while preserving the pre-H5 staged active/planned split. | `Mission Statement`, `Core Success Metrics` | `plan:m365-authoritative-persona-registry-and-capability-map-rebase:R1` |
| `plans/m365-authoritative-persona-registry-and-capability-map-rebase/m365-authoritative-persona-registry-and-capability-map-rebase.yaml` | Structured YAML authority for the draft H3 authoritative registry and capability-map rebase phase. | `Technical Architecture`, `Core Success Metrics` | `plan:m365-authoritative-persona-registry-and-capability-map-rebase:R1` |
| `plans/m365-authoritative-persona-registry-and-capability-map-rebase/m365-authoritative-persona-registry-and-capability-map-rebase.json` | Structured JSON mirror for the draft H3 authoritative registry and capability-map rebase phase. | `Technical Architecture`, `Core Success Metrics` | `plan:m365-authoritative-persona-registry-and-capability-map-rebase:R1` |
| `docs/prompts/codex-m365-authoritative-persona-registry-and-capability-map-rebase.md` | Detailed prompt for executing the H3 notebook-first authoritative registry and capability-map rebase phase after approval. | `Policy & Security`, `Technical Architecture` | `plan:m365-authoritative-persona-registry-and-capability-map-rebase:R1` |
| `docs/prompts/codex-m365-authoritative-persona-registry-and-capability-map-rebase-prompt.txt` | Kickoff prompt for the draft H3 authoritative registry and capability-map rebase phase. | `Policy & Security`, `Technical Architecture` | `plan:m365-authoritative-persona-registry-and-capability-map-rebase:R1` |
