...
| `plans/m365-authoritative-persona-h4-scope-correction/m365-authoritative-persona-h4-scope-correction.md` | Draft blocker child plan that corrects the H4 scope gap by owning the department-pack authority rebase required before certification/count rebase can continue. | `Mission Statement`, `Core Success Metrics` | `plan:m365-authoritative-persona-h4-scope-correction:R1` |
| `plans/m365-authoritative-persona-h4-scope-correction/m365-authoritative-persona-h4-scope-correction.yaml` | Structured YAML authority for the draft H4 scope-correction blocker phase. | `Technical Architecture`, `Core Success Metrics` | `plan:m365-authoritative-persona-h4-scope-correction:R1` |
| `plans/m365-authoritative-persona-h4-scope-correction/m365-authoritative-persona-h4-scope-correction.json` | Structured JSON mirror for the draft H4 scope-correction blocker phase. | `Technical Architecture`, `Core Success Metrics` | `plan:m365-authoritative-persona-h4-scope-correction:R1` |
| `docs/prompts/codex-m365-authoritative-persona-h4-scope-correction.md` | Detailed prompt for executing the H4S notebook-first department-pack authority rebase phase after approval. | `Policy & Security`, `Technical Architecture` | `plan:m365-authoritative-persona-h4-scope-correction:R1` |
| `docs/prompts/codex-m365-authoritative-persona-h4-scope-correction-prompt.txt` | Kickoff prompt for the draft H4S scope-correction blocker phase. | `Policy & Security`, `Technical Architecture` | `plan:m365-authoritative-persona-h4-scope-correction:R1` |
...
| `plans/m365-authoritative-persona-certification-and-count-rebase/m365-authoritative-persona-certification-and-count-rebase.md` | Draft H4 child plan for rebasing certification and count truth after the H4S department-pack blocker closes. | `Mission Statement`, `Core Success Metrics` | `plan:m365-authoritative-persona-certification-and-count-rebase:R1` |
| `plans/m365-authoritative-persona-certification-and-count-rebase/m365-authoritative-persona-certification-and-count-rebase.yaml` | Structured YAML authority for the draft H4 certification and count rebase phase, now blocked pending H4S closeout. | `Technical Architecture`, `Core Success Metrics` | `plan:m365-authoritative-persona-certification-and-count-rebase:R1` |
| `plans/m365-authoritative-persona-certification-and-count-rebase/m365-authoritative-persona-certification-and-count-rebase.json` | Structured JSON mirror for the draft H4 certification and count rebase phase, now blocked pending H4S closeout. | `Technical Architecture`, `Core Success Metrics` | `plan:m365-authoritative-persona-certification-and-count-rebase:R1` |
| `docs/prompts/codex-m365-authoritative-persona-certification-and-count-rebase.md` | Detailed prompt for executing the H4 notebook-first certification and count rebase phase after H4S closes and approval is renewed. | `Policy & Security`, `Technical Architecture` | `plan:m365-authoritative-persona-certification-and-count-rebase:R1` |
| `docs/prompts/codex-m365-authoritative-persona-certification-and-count-rebase-prompt.txt` | Kickoff prompt for the draft H4 certification and count rebase phase, explicitly gated behind H4S. | `Policy & Security`, `Technical Architecture` | `plan:m365-authoritative-persona-certification-and-count-rebase:R1` |
