...
| `plans/m365-authoritative-persona-certification-and-count-rebase/m365-authoritative-persona-certification-and-count-rebase.md` | Draft H4 child plan for rebasing certification and count truth now that H4S has closed the department-pack dependency surface. | `Mission Statement`, `Core Success Metrics` | `plan:m365-authoritative-persona-certification-and-count-rebase:R1` |
| `plans/m365-authoritative-persona-certification-and-count-rebase/m365-authoritative-persona-certification-and-count-rebase.yaml` | Structured YAML authority for the draft H4 certification and count rebase phase, now unblocked for the next governed act. | `Technical Architecture`, `Core Success Metrics` | `plan:m365-authoritative-persona-certification-and-count-rebase:R1` |
| `plans/m365-authoritative-persona-certification-and-count-rebase/m365-authoritative-persona-certification-and-count-rebase.json` | Structured JSON mirror for the draft H4 certification and count rebase phase, now unblocked for the next governed act. | `Technical Architecture`, `Core Success Metrics` | `plan:m365-authoritative-persona-certification-and-count-rebase:R1` |
| `docs/prompts/codex-m365-authoritative-persona-certification-and-count-rebase.md` | Detailed prompt for executing the H4 notebook-first certification and count rebase phase now that H4S is green. | `Policy & Security`, `Technical Architecture` | `plan:m365-authoritative-persona-certification-and-count-rebase:R1` |
| `docs/prompts/codex-m365-authoritative-persona-certification-and-count-rebase-prompt.txt` | Kickoff prompt for the draft H4 certification and count rebase phase after H4S closeout. | `Policy & Security`, `Technical Architecture` | `plan:m365-authoritative-persona-certification-and-count-rebase:R1` |
