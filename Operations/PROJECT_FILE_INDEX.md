...
| `plans/m365-token-provider-runtime-repair/m365-token-provider-runtime-repair.md` | P3A child plan: bounded M365-side runtime/auth repair. Draft until approved. | `Technical Architecture` | `plan:m365-token-provider-runtime-repair:R1` |
| `plans/m365-token-provider-runtime-repair/m365-token-provider-runtime-repair.yaml` | Structured YAML authority for P3A bounded M365-side runtime/auth repair. | `Technical Architecture` | `plan:m365-token-provider-runtime-repair:R1` |
| `plans/m365-token-provider-runtime-repair/m365-token-provider-runtime-repair.json` | Structured JSON authority for P3A bounded M365-side runtime/auth repair. | `Technical Architecture` | `plan:m365-token-provider-runtime-repair:R1` |
...
| `docs/prompts/codex-m365-token-provider-runtime-repair.md` | P3A detailed MATHS prompt. | `Technical Architecture` | `plan:m365-token-provider-runtime-repair:R1` |
| `docs/prompts/codex-m365-token-provider-runtime-repair-prompt.txt` | P3A kickoff prompt. | `Technical Architecture` | `plan:m365-token-provider-runtime-repair:R1` |
