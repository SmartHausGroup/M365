...
| `plans/m365-authoritative-persona-humanized-employee-record-completion/m365-authoritative-persona-humanized-employee-record-completion.md` | Draft H2 child plan for creating the bounded named employee-record artifact for the 20 promoted personas before any authoritative registry rebase. | `Mission Statement`, `Core Success Metrics` | `plan:m365-authoritative-persona-humanized-employee-record-completion:R1` |
| `plans/m365-authoritative-persona-humanized-employee-record-completion/m365-authoritative-persona-humanized-employee-record-completion.yaml` | Structured YAML authority for the draft H2 employee-record completion phase. | `Technical Architecture`, `Core Success Metrics` | `plan:m365-authoritative-persona-humanized-employee-record-completion:R1` |
| `plans/m365-authoritative-persona-humanized-employee-record-completion/m365-authoritative-persona-humanized-employee-record-completion.json` | Structured JSON mirror for the draft H2 employee-record completion phase. | `Technical Architecture`, `Core Success Metrics` | `plan:m365-authoritative-persona-humanized-employee-record-completion:R1` |
| `docs/prompts/codex-m365-authoritative-persona-humanized-employee-record-completion.md` | Detailed prompt for executing the H2 notebook-first employee-record completion phase after approval. | `Policy & Security`, `Technical Architecture` | `plan:m365-authoritative-persona-humanized-employee-record-completion:R1` |
| `docs/prompts/codex-m365-authoritative-persona-humanized-employee-record-completion-prompt.txt` | Kickoff prompt for the draft H2 employee-record completion phase. | `Policy & Security`, `Technical Architecture` | `plan:m365-authoritative-persona-humanized-employee-record-completion:R1` |
