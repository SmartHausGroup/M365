...
def load_departments() -> dict[str, dict[str, Any]]:
    ...
    try:
        ...
        dept_mapping = {
            "operations": {
                "name": "Operations",
                "description": "M365 administration, website management, and system operations",
                "icon": "🔧",
                "color": "#1976d2",
            },
            "hr": {
                "name": "Human Resources",
                "description": "Employee management, onboarding, and policy administration",
                "icon": "👥",
                "color": "#9c27b0",
            },
            "communication": {
                "name": "Communications",
                "description": "Outreach coordination and external communications",
                "icon": "📢",
                "color": "#ff9800",
            },
            "engineering": {
                "name": "Engineering",
                "description": "AI development, backend architecture, and technical implementation",
                "icon": "⚙️",
                "color": "#28a745",
            },
            "marketing": {
                "name": "Marketing",
                "description": "Content creation, growth hacking, and social media management",
                "icon": "📈",
                "color": "#ffc107",
            },
            "product": {
            ...
            "project-management": {
                ...
                "description": "Project coordination, shipping, and studio production",
                "icon": "🚀",
                "color": "#4caf50",
            },
            "studio-operations": {
                "name": "Studio Operations",
                "description": "Analytics, finance, infrastructure, legal, and customer support",
                "icon": "🏢",
                "color": "#607d8b",
            },
            "testing": {
                "name": "Testing & Quality",
                "description": "API testing, performance benchmarking, and quality assurance",
                "icon": "🧪",
                "color": "#795548",
            },
            "design": {
                "name": "Design",
                "description": "Brand management, UX/UI design, and visual identity",
                "icon": "🎨",
                "color": "#e91e63",
            },
            "bonus": {
                "name": "Special Teams",
                "description": "Performance coaching and team morale",
                "icon": "⭐",
                "color": "#9c27b0",
            },
        }
                    ...
                    "agents": [
                        {
                            ...
                            "workload": (
                                "High"
                                if "Senior" in agent["role"]
                                or "Lead" in agent["role"]
                                or "Director" in agent["role"]
                                else "Medium"
                            ),
                        }
                        for agent in agents
...
# Load real data
def load_real_data() -> dict[str, int]:
    ...
    try:
        ...
        # Load project data
        with open("data/smarthaus_website_projects.json") as f:
            project_data = json.load(f)

        # Load client data
        with open("data/clients_projects.json") as f:
            client_data = json.load(f)

        # Load agent tasks
        with open("data/agent_tasks_m365-administrator.json") as f:
        ...
        pending_tasks = len(
            [task for task in task_data if task.get("status") in ["pending", "in_progress"]]
        )
...
async def unified_dashboard(request: Request) -> HTMLResponse:
...
async def department_page(request: Request, dept_id: str) -> HTMLResponse:
