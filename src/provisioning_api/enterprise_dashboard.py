...
async def fetch_m365_metrics() -> Dict[str, Any]:
    ...
    if not token:
        ...
        return {
            "services": [
                {"service": "Azure AD", "status": "Healthy", "health_score": 98, "users": 47, "last_sync": "2 min ago"},
                {"service": "Exchange Online", "status": "Healthy", "health_score": 95, "mailboxes": 47, "last_sync": "1 min ago"},
                {"service": "SharePoint Online", "status": "Healthy", "health_score": 92, "sites": 12, "last_sync": "3 min ago"},
                {"service": "Teams", "status": "Healthy", "health_score": 96, "teams": 8, "last_sync": "1 min ago"},
                {"service": "Power Platform", "status": "Healthy", "health_score": 89, "flows": 15, "last_sync": "5 min ago"},
                {"service": "Security & Compliance", "status": "Warning", "health_score": 85, "alerts": 3, "last_sync": "2 min ago"}
            ],
            "business_units": [
                {"unit": "TAI Quantum AIUCP", "users": 12, "storage": "2.3 TB", "cost": 1240.50, "compliance": 95, "projects": 3},
                {"unit": "SmartHaus Website", "users": 8, "storage": "1.8 TB", "cost": 890.25, "compliance": 98, "projects": 2},
                {"unit": "LATTICE Research", "users": 15, "storage": "4.1 TB", "cost": 2100.75, "compliance": 92, "projects": 4},
                {"unit": "Enterprise Advisory", "users": 12, "storage": "1.2 TB", "cost": 675.00, "compliance": 99, "projects": 1}
            ],
            "security_alerts": [
                {"id": "SEC-001", "severity": "High", "title": "Unusual sign-in activity", "affected": 3, "status": "Active"},
                {"id": "SEC-002", "severity": "Medium", "title": "Privileged account access", "affected": 1, "status": "Investigating"},
                {"id": "SEC-003", "severity": "Low", "title": "Password policy violation", "affected": 5, "status": "Resolved"}
            ],
            "projects": [
                {"id": "TAI-001", "name": "Quantum Core Development", "unit": "TAI", "status": "Active", "progress": 75, "budget": 45000, "team": 8, "milestone": "Beta Release", "risk": "Low"},
                {"id": "WEB-001", "name": "Website Platform v2.0", "unit": "SmartHaus", "status": "Active", "progress": 60, "budget": 25000, "team": 6, "milestone": "UI/UX Complete", "risk": "Medium"},
                {"id": "LAT-001", "name": "LQL Research Platform", "unit": "LATTICE", "status": "Planning", "progress": 25, "budget": 35000, "team": 10, "milestone": "Architecture Review", "risk": "High"}
            ]
        }
