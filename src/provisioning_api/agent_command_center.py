...
AGENT_COMMAND_SYSTEMS: dict[str, dict[str, Any]] = {
    "alex-thompson": {
        "name": "Alex Thompson",
        "role": "ML Engineer",
        "command_interfaces": {
...
async def command_center_home(request: Request) -> HTMLResponse:
            ...
            [
                ...
                <div class="agent-card">
                    <div class="agent-header">
                        ...
                        <button class="btn btn-primary" onclick="openAgentConsole('{
                    agent_id
                }')">Open Console</button>
                    </div>
                    ...
                    <div style="margin-top: 1rem;">
                        <button class="btn btn-success" onclick="viewAgentDetails('{
                    agent_id
                }')">View Details</button>
                        <button class="btn btn-warning" onclick="scheduleWorkflow('{
                    agent_id
...
async def agent_console(request: Request, agent_id: str) -> HTMLResponse:
...
async def execute_agent_command(agent_id: str, command: AgentCommand) -> AgentResponse:
