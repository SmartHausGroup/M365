...
def main() -> int:
    ...
    authority = load_department_pack_authority(
        "communication",
        path=repo_root / "registry" / "department_pack_communication_v1.yaml",
    )
    ...
    output_path = (
        repo_root / "configs" / "generated" / "communication_department_pack_v1_verification.json"
    )
