...
def main() -> int:
    ...
    authority = load_department_pack_authority(
        "project-management",
        path=repo_root / "registry" / "department_pack_project_management_v1.yaml",
    )
    ...
    if summary["supported_action_count"] != 26:
    ...
    output_path = (
        ...
        / "configs"
        / "generated"
        / "project_management_department_pack_v1_verification.json"
    )
