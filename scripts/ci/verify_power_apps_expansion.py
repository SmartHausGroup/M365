...
REGISTRY_PATH = REPO_ROOT / "registry" / "power_apps_expansion_v2.yaml"
CAPABILITY_REGISTRY_PATH = REPO_ROOT / "registry" / "capability_registry.yaml"
ARTIFACT_PATH = REPO_ROOT / "configs" / "generated" / "power_apps_expansion_verification.json"
