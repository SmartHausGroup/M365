...
REGISTRY_PATH = REPO_ROOT / "registry" / "sharepoint_onedrive_files_expansion_v2.yaml"
CAPABILITY_REGISTRY_PATH = REPO_ROOT / "registry" / "capability_registry.yaml"
ARTIFACT_PATH = (
    REPO_ROOT / "configs" / "generated" / "sharepoint_onedrive_files_expansion_verification.json"
)
...
def main() -> int:
    ...
    print(
        "verify_sharepoint_onedrive_files_expansion:",
