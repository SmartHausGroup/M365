...
def get_admin_user_id(client: GraphClient, admin_email: str) -> str | None:
...
def ensure_group_owner(client: GraphClient, group_id: str, owner_id: str) -> bool:
...
def create_team_from_group(client: GraphClient, group_id: str, display_name: str) -> bool:
