# Codex Execution Prompt — plan:m365-cps-trkB-p1-sharepoint-reads:T8
...
- **Task:** `T8` — Update legacy alias table
- **Branch:** `feat/m365-cps-trkB`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkB-p1-sharepoint-reads-T8
...
Plan reference: `plan:m365-cps-trkB-p1-sharepoint-reads:T8`. Branch: `feat/m365-cps-trkB`.
...
git add <files>
git commit -m "plan:m365-cps-trkB-p1-sharepoint-reads:T8 — Update legacy alias table"
```
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkB-p1-sharepoint-reads:T8`
...
- Reference `plan:m365-cps-trkB-p1-sharepoint-reads:T8` in commit message
