# Codex Execution Prompt — plan:m365-cps-trkC-p5-end-to-end:T5
...
- **Task:** `T5` — Final commit (Track C complete)
- **Branch:** `feat/m365-cps-trkC`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkC-p5-end-to-end-T5
...
- **Task name:** Final commit (Track C complete)
- **Domain:** framework
- **Owner:** Phil Siniscalchi (Founder/Owner)
- **Dependencies:** T4
...
Plan reference: `plan:m365-cps-trkC-p5-end-to-end:T5`. Branch: `feat/m365-cps-trkC`.
...
# 3. Validate
cd $M365_ROOT && git log --oneline -1 | grep 'plan:m365-cps-trkC-p5'
...
git add <files>
git commit -m "plan:m365-cps-trkC-p5-end-to-end:T5 — Final commit (Track C complete)"
```
...
- Validation command exits 0: `cd $M365_ROOT && git log --oneline -1 | grep 'plan:m365-cps-trkC-p5'`
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkC-p5-end-to-end:T5`
...
- **Validation result:** `cd $M365_ROOT && git log --oneline -1 | grep 'plan:m365-cps-trkC-p5'` exits 0
...
- Reference `plan:m365-cps-trkC-p5-end-to-end:T5` in commit message
