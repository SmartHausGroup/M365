# Codex Execution Prompt — plan:m365-cps-trkC-p3-mcp-tool-docstrings:T3
...
- **Task:** `T3` — Add docstring linter to CI
- **Branch:** `feat/m365-cps-trkC`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkC-p3-mcp-tool-docstrings-T3
...
- **Task name:** Add docstring linter to CI
- **Domain:** framework
- **Owner:** Phil Siniscalchi (Founder/Owner)
- **Dependencies:** T2
...
Linter script checks: every action listed in a docstring has a coverage_status marker; every implemented action has a registry entry.

Plan reference: `plan:m365-cps-trkC-p3-mcp-tool-docstrings:T3`. Branch: `feat/m365-cps-trkC`.
...
git add <files>
git commit -m "plan:m365-cps-trkC-p3-mcp-tool-docstrings:T3 — Add docstring linter to CI"
```
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkC-p3-mcp-tool-docstrings:T3`
...
- Reference `plan:m365-cps-trkC-p3-mcp-tool-docstrings:T3` in commit message
