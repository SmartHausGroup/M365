# Codex Execution Prompt — plan:m365-cps-trkB-p2-calendar-reads:T10
...
- **Task:** `T10` — Pre-commit + make test
- **Branch:** `feat/m365-cps-trkB`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkB-p2-calendar-reads-T10
...
Plan reference: `plan:m365-cps-trkB-p2-calendar-reads:T10`. Branch: `feat/m365-cps-trkB`.
...
git add <files>
git commit -m "plan:m365-cps-trkB-p2-calendar-reads:T10 — Pre-commit + make test"
```
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkB-p2-calendar-reads:T10`
...
- Reference `plan:m365-cps-trkB-p2-calendar-reads:T10` in commit message
