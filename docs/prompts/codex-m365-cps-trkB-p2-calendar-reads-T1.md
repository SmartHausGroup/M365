# Codex Execution Prompt — plan:m365-cps-trkB-p2-calendar-reads:T1
...
- Prompt version: v1.0
- Task ID: m365-cps-trkB-p2-calendar-reads-T1
...
Plan reference: `plan:m365-cps-trkB-p2-calendar-reads:T1`. Branch: `feat/m365-cps-trkB`.
...
git add <files>
git commit -m "plan:m365-cps-trkB-p2-calendar-reads:T1 — Read context for parent phase"
```
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkB-p2-calendar-reads:T1`
...
- Reference `plan:m365-cps-trkB-p2-calendar-reads:T1` in commit message
