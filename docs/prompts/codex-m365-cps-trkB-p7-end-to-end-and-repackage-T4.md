# Codex Execution Prompt — plan:m365-cps-trkB-p7-end-to-end-and-repackage:T4

## Governance Lock (Read FIRST)

- `AGENTS.md` / `CLAUDE.md` (M365 repo and UCP repo)
- `docs/NORTH_STAR.md` (UCP) / `Operations/NORTHSTAR.md` (M365)
- `plans/m365-cps-trkB-p7-end-to-end-and-repackage/m365-cps-trkB-p7-end-to-end-and-repackage.md` (parent phase plan)
...
- **Plan:** `plan:m365-cps-trkB-p7-end-to-end-and-repackage`
- **Parent track:** `plan:m365-cps-trkB-coverage`
- **Master plan:** `plan:m365-capability-pack-surface-remediation`
- **Task:** `T4` — Update UCP release_artifacts.py spec
- **Branch:** `feat/m365-cps-trkB`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkB-p7-end-to-end-and-repackage-T4
...
- **Task name:** Update UCP release_artifacts.py spec
- **Domain:** framework
- **Owner:** Phil Siniscalchi (Founder/Owner)
- **Dependencies:** T3
...
Add M365_120_RELEASE_SPEC; update M365_RELEASE_SPEC alias to point at 1.2.0.

Plan reference: `plan:m365-cps-trkB-p7-end-to-end-and-repackage:T4`. Branch: `feat/m365-cps-trkB`.
...
# 3. Validate
cd $UCP_ROOT && .venv/bin/python -c "from ucp.runtime.release_artifacts import M365_RELEASE_SPEC; assert M365_RELEASE_SPEC.version == '1.2.0'"
...
git add <files>
git commit -m "plan:m365-cps-trkB-p7-end-to-end-and-repackage:T4 — Update UCP release_artifacts.py spec"
```
...
- Validation command exits 0: `cd $UCP_ROOT && .venv/bin/python -c "from ucp.runtime.release_artifacts import M365_RELEASE_SPEC; assert M365_RELEASE_SPEC.version == '1.2.0'"`
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkB-p7-end-to-end-and-repackage:T4`
...
- **Validation result:** `cd $UCP_ROOT && .venv/bin/python -c "from ucp.runtime.release_artifacts import M365_RELEASE_SPEC; assert M365_RELEASE_SPEC.version == '1.2.0'"` exits 0
...
- Reference `plan:m365-cps-trkB-p7-end-to-end-and-repackage:T4` in commit message
