# Codex Execution Prompt — plan:m365-cps-trkC-p4-operator-capability-map:T2
...
- **Task:** `T2` — Add capability map to M365 docs/
- **Branch:** `feat/m365-cps-trkC`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkC-p4-operator-capability-map-T2
...
- **Task name:** Add capability map to M365 docs/
- **Domain:** framework
- **Owner:** Phil Siniscalchi (Founder/Owner)
- **Dependencies:** T1
...
docs/m365_capability_map.md committed; README links to it.

Plan reference: `plan:m365-cps-trkC-p4-operator-capability-map:T2`. Branch: `feat/m365-cps-trkC`.
...
# 3. Validate
test -f $M365_ROOT/docs/m365_capability_map.md
...
git add <files>
git commit -m "plan:m365-cps-trkC-p4-operator-capability-map:T2 — Add capability map to M365 docs/"
```
...
- Validation command exits 0: `test -f $M365_ROOT/docs/m365_capability_map.md`
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkC-p4-operator-capability-map:T2`
...
- **Validation result:** `test -f $M365_ROOT/docs/m365_capability_map.md` exits 0
...
- Reference `plan:m365-cps-trkC-p4-operator-capability-map:T2` in commit message
