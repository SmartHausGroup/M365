# Codex Execution Prompt — plan:m365-cps-trkB-p7-end-to-end-and-repackage:T2
...
- **Task:** `T2` — Re-bump M365 version
- **Branch:** `feat/m365-cps-trkB`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkB-p7-end-to-end-and-repackage-T2
...
- **Task name:** Re-bump M365 version
- **Domain:** framework
- **Owner:** Phil Siniscalchi (Founder/Owner)
- **Dependencies:** T1
...
Update src/m365_runtime/**init**.py version constant to 1.2.0; update pyproject.toml.

Plan reference: `plan:m365-cps-trkB-p7-end-to-end-and-repackage:T2`. Branch: `feat/m365-cps-trkB`.
...
# 3. Validate
cd $M365_ROOT && grep -n '1.2.0' src/m365_runtime/__init__.py pyproject.toml
...
git add <files>
git commit -m "plan:m365-cps-trkB-p7-end-to-end-and-repackage:T2 — Re-bump M365 version"
```
...
- Validation command exits 0: `cd $M365_ROOT && grep -n '1.2.0' src/m365_runtime/__init__.py pyproject.toml`
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkB-p7-end-to-end-and-repackage:T2`
...
- **Validation result:** `cd $M365_ROOT && grep -n '1.2.0' src/m365_runtime/__init__.py pyproject.toml` exits 0
...
- Reference `plan:m365-cps-trkB-p7-end-to-end-and-repackage:T2` in commit message
