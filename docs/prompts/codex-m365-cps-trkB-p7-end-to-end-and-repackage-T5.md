# Codex Execution Prompt — plan:m365-cps-trkB-p7-end-to-end-and-repackage:T5
...
- **Task:** `T5` — Re-verify SHA256 + provenance
- **Branch:** `feat/m365-cps-trkB`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkB-p7-end-to-end-and-repackage-T5
...
- **Task name:** Re-verify SHA256 + provenance
- **Domain:** framework
- **Owner:** Phil Siniscalchi (Founder/Owner)
- **Dependencies:** T4
...
Update expected_bundle_sha256 in M365_120_RELEASE_SPEC; run release artifact acceptance test.

Plan reference: `plan:m365-cps-trkB-p7-end-to-end-and-repackage:T5`. Branch: `feat/m365-cps-trkB`.
...
# 3. Validate
cd $UCP_ROOT && .venv/bin/python scripts/verify_release_artifact.py M365_120_RELEASE_SPEC
...
git add <files>
git commit -m "plan:m365-cps-trkB-p7-end-to-end-and-repackage:T5 — Re-verify SHA256 + provenance"
```
...
- Validation command exits 0: `cd $UCP_ROOT && .venv/bin/python scripts/verify_release_artifact.py M365_120_RELEASE_SPEC`
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkB-p7-end-to-end-and-repackage:T5`
...
- **Validation result:** `cd $UCP_ROOT && .venv/bin/python scripts/verify_release_artifact.py M365_120_RELEASE_SPEC` exits 0
...
- Reference `plan:m365-cps-trkB-p7-end-to-end-and-repackage:T5` in commit message
