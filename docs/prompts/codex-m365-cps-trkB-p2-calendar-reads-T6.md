# Codex Execution Prompt — plan:m365-cps-trkB-p2-calendar-reads:T6
...
- **Task:** `T6` — Update legacy alias table
- **Branch:** `feat/m365-cps-trkB`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkB-p2-calendar-reads-T6
...
Plan reference: `plan:m365-cps-trkB-p2-calendar-reads:T6`. Branch: `feat/m365-cps-trkB`.
...
git add <files>
git commit -m "plan:m365-cps-trkB-p2-calendar-reads:T6 — Update legacy alias table"
```
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkB-p2-calendar-reads:T6`
...
- Reference `plan:m365-cps-trkB-p2-calendar-reads:T6` in commit message
