# Codex Execution Prompt — plan:m365-cps-trkA-p2-inventory-tool:T6
...
- **Task:** `T6` — Pre-commit + make test in both repos
- **Branch:** `feat/m365-cps-trkA`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkA-p2-inventory-tool-T6
...
Standard validation gate before commit.

Plan reference: `plan:m365-cps-trkA-p2-inventory-tool:T6`. Branch: `feat/m365-cps-trkA`.
...
git add <files>
git commit -m "plan:m365-cps-trkA-p2-inventory-tool:T6 — Pre-commit + make test in both repos"
```
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkA-p2-inventory-tool:T6`
...
- Reference `plan:m365-cps-trkA-p2-inventory-tool:T6` in commit message
