# Codex Execution Prompt — plan:m365-cps-trkB-p5-directory-and-teams:T7
...
- **Task:** `T7` — Update legacy alias table
- **Branch:** `feat/m365-cps-trkB`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkB-p5-directory-and-teams-T7
...
Plan reference: `plan:m365-cps-trkB-p5-directory-and-teams:T7`. Branch: `feat/m365-cps-trkB`.
...
git add <files>
git commit -m "plan:m365-cps-trkB-p5-directory-and-teams:T7 — Update legacy alias table"
```
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkB-p5-directory-and-teams:T7`
...
- Reference `plan:m365-cps-trkB-p5-directory-and-teams:T7` in commit message
