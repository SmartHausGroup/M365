# Codex Execution Prompt — plan:m365-cps-trkA-p3-preflight-intersection:T6
...
- **Task:** `T6` — Pre-commit + make test
- **Branch:** `feat/m365-cps-trkA`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkA-p3-preflight-intersection-T6
...
Plan reference: `plan:m365-cps-trkA-p3-preflight-intersection:T6`. Branch: `feat/m365-cps-trkA`.
...
git add <files>
git commit -m "plan:m365-cps-trkA-p3-preflight-intersection:T6 — Pre-commit + make test"
```
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkA-p3-preflight-intersection:T6`
...
- Reference `plan:m365-cps-trkA-p3-preflight-intersection:T6` in commit message
