# Codex Execution Prompt — plan:m365-cps-trkB-p4-health-and-reports:T11
...
- **Task:** `T11` — Update YAML registry mirror
- **Branch:** `feat/m365-cps-trkB`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkB-p4-health-and-reports-T11
...
Plan reference: `plan:m365-cps-trkB-p4-health-and-reports:T11`. Branch: `feat/m365-cps-trkB`.
...
- Cross-task changes (this prompt is scoped to T11 only)
...
git add <files>
git commit -m "plan:m365-cps-trkB-p4-health-and-reports:T11 — Update YAML registry mirror"
```
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkB-p4-health-and-reports:T11`
...
- Reference `plan:m365-cps-trkB-p4-health-and-reports:T11` in commit message
