# Codex Execution Prompt — plan:m365-cps-trkB-p5-directory-and-teams:T11
...
- **Task:** `T11` — Pre-commit + make test
- **Branch:** `feat/m365-cps-trkB`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkB-p5-directory-and-teams-T11
...
- **Task name:** Pre-commit + make test
- **Domain:** framework
- **Owner:** Phil Siniscalchi (Founder/Owner)
- **Dependencies:** T10
...
Plan reference: `plan:m365-cps-trkB-p5-directory-and-teams:T11`. Branch: `feat/m365-cps-trkB`.
...
git add <files>
git commit -m "plan:m365-cps-trkB-p5-directory-and-teams:T11 — Pre-commit + make test"
```
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkB-p5-directory-and-teams:T11`
...
- Reference `plan:m365-cps-trkB-p5-directory-and-teams:T11` in commit message
