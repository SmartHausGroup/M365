# Codex Execution Prompt — plan:m365-cps-trkC-p1-coverage-status-contract:T2
...
- **Task:** `T2` — Document semantics
- **Branch:** `feat/m365-cps-trkC`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkC-p1-coverage-status-contract-T2
...
Document each enum value's semantics: implemented (in registry), aliased (alias maps to a registry entry), planned (declared but not implemented), deprecated (was implemented, now removed).

Plan reference: `plan:m365-cps-trkC-p1-coverage-status-contract:T2`. Branch: `feat/m365-cps-trkC`.
...
# 3. Validate
test -f $M365_ROOT/docs/contracts/m365_coverage_status.md
...
git add <files>
git commit -m "plan:m365-cps-trkC-p1-coverage-status-contract:T2 — Document semantics"
```
...
- Validation command exits 0: `test -f $M365_ROOT/docs/contracts/m365_coverage_status.md`
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkC-p1-coverage-status-contract:T2`
...
- **Validation result:** `test -f $M365_ROOT/docs/contracts/m365_coverage_status.md` exits 0
...
- Reference `plan:m365-cps-trkC-p1-coverage-status-contract:T2` in commit message
