# Codex Execution Prompt — plan:m365-cps-trkB-p1-sharepoint-reads:T12
...
- **Task:** `T12` — Pre-commit + make test
- **Branch:** `feat/m365-cps-trkB`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkB-p1-sharepoint-reads-T12
...
Plan reference: `plan:m365-cps-trkB-p1-sharepoint-reads:T12`. Branch: `feat/m365-cps-trkB`.
...
git add <files>
git commit -m "plan:m365-cps-trkB-p1-sharepoint-reads:T12 — Pre-commit + make test"
```
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkB-p1-sharepoint-reads:T12`
...
- Reference `plan:m365-cps-trkB-p1-sharepoint-reads:T12` in commit message
