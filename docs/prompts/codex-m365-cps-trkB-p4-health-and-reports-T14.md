# Codex Execution Prompt — plan:m365-cps-trkB-p4-health-and-reports:T14
...
- **Task:** `T14` — Pre-commit + make test
- **Branch:** `feat/m365-cps-trkB`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkB-p4-health-and-reports-T14
...
Plan reference: `plan:m365-cps-trkB-p4-health-and-reports:T14`. Branch: `feat/m365-cps-trkB`.
...
- Cross-task changes (this prompt is scoped to T14 only)
...
git add <files>
git commit -m "plan:m365-cps-trkB-p4-health-and-reports:T14 — Pre-commit + make test"
```
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkB-p4-health-and-reports:T14`
...
- Reference `plan:m365-cps-trkB-p4-health-and-reports:T14` in commit message
