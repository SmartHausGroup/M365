# Codex Execution Prompt — plan:m365-cps-trkC-p5-end-to-end:T3
...
- **Task:** `T3` — E2E: docstrings match registry
- **Branch:** `feat/m365-cps-trkC`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkC-p5-end-to-end-T3
...
- **Task name:** E2E: docstrings match registry
- **Domain:** framework
- **Owner:** Phil Siniscalchi (Founder/Owner)
- **Dependencies:** T2
...
Run docstring linter against current registry state; assert no drift.

Plan reference: `plan:m365-cps-trkC-p5-end-to-end:T3`. Branch: `feat/m365-cps-trkC`.
...
git add <files>
git commit -m "plan:m365-cps-trkC-p5-end-to-end:T3 — E2E: docstrings match registry"
```
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkC-p5-end-to-end:T3`
...
- Reference `plan:m365-cps-trkC-p5-end-to-end:T3` in commit message
