# Codex Execution Prompt — plan:m365-cps-trkC-p3-mcp-tool-docstrings:T4
...
- Prompt version: v1.0
- Task ID: m365-cps-trkC-p3-mcp-tool-docstrings-T4
...
Plan reference: `plan:m365-cps-trkC-p3-mcp-tool-docstrings:T4`. Branch: `feat/m365-cps-trkC`.
...
# 3. Validate
cd $UCP_ROOT && pre-commit run --all-files && make test && git log --oneline -1 | grep 'plan:m365-cps-trkC-p3'
...
git add <files>
git commit -m "plan:m365-cps-trkC-p3-mcp-tool-docstrings:T4 — Pre-commit + commit"
```
...
- Validation command exits 0: `cd $UCP_ROOT && pre-commit run --all-files && make test && git log --oneline -1 | grep 'plan:m365-cps-trkC-p3'`
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkC-p3-mcp-tool-docstrings:T4`
...
- **Validation result:** `cd $UCP_ROOT && pre-commit run --all-files && make test && git log --oneline -1 | grep 'plan:m365-cps-trkC-p3'` exits 0
...
- Reference `plan:m365-cps-trkC-p3-mcp-tool-docstrings:T4` in commit message
