# Codex Execution Prompt — plan:m365-cps-trkC-p5-end-to-end:T2
...
- **Task:** `T2` — E2E: invoke implemented action returns success
- **Branch:** `feat/m365-cps-trkC`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkC-p5-end-to-end-T2
...
- **Task name:** E2E: invoke implemented action returns success
- **Domain:** framework
- **Owner:** Phil Siniscalchi (Founder/Owner)
- **Dependencies:** T1
...
Live test on an implemented action; assert success.

Plan reference: `plan:m365-cps-trkC-p5-end-to-end:T2`. Branch: `feat/m365-cps-trkC`.
...
# 3. Validate
cd $UCP_ROOT && .venv/bin/python tests/integration/m365_implemented_action_live.py
...
git add <files>
git commit -m "plan:m365-cps-trkC-p5-end-to-end:T2 — E2E: invoke implemented action returns success"
```
...
- Validation command exits 0: `cd $UCP_ROOT && .venv/bin/python tests/integration/m365_implemented_action_live.py`
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkC-p5-end-to-end:T2`
...
- **Validation result:** `cd $UCP_ROOT && .venv/bin/python tests/integration/m365_implemented_action_live.py` exits 0
...
- Reference `plan:m365-cps-trkC-p5-end-to-end:T2` in commit message
