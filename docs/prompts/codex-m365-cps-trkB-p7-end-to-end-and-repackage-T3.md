# Codex Execution Prompt — plan:m365-cps-trkB-p7-end-to-end-and-repackage:T3
...
- **Task:** `T3` — Re-package marketplace artifact
- **Branch:** `feat/m365-cps-trkB`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkB-p7-end-to-end-and-repackage-T3
...
- **Task name:** Re-package marketplace artifact
- **Domain:** framework
- **Owner:** Phil Siniscalchi (Founder/Owner)
- **Dependencies:** T2
...
Run make pack to produce com.smarthaus.m365-1.2.0.ucp.tar.gz and IntegrationPacks/M365/1.2.0/ contents.

Plan reference: `plan:m365-cps-trkB-p7-end-to-end-and-repackage:T3`. Branch: `feat/m365-cps-trkB`.
...
# 3. Validate
ls $INTEGRATION_PACKS_ROOT/M365/1.2.0/com.smarthaus.m365-1.2.0.ucp.tar.gz
...
git add <files>
git commit -m "plan:m365-cps-trkB-p7-end-to-end-and-repackage:T3 — Re-package marketplace artifact"
```
...
- Validation command exits 0: `ls $INTEGRATION_PACKS_ROOT/M365/1.2.0/com.smarthaus.m365-1.2.0.ucp.tar.gz`
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkB-p7-end-to-end-and-repackage:T3`
...
- **Validation result:** `ls $INTEGRATION_PACKS_ROOT/M365/1.2.0/com.smarthaus.m365-1.2.0.ucp.tar.gz` exits 0
...
- Reference `plan:m365-cps-trkB-p7-end-to-end-and-repackage:T3` in commit message
