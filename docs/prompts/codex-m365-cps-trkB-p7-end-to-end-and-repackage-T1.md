# Codex Execution Prompt — plan:m365-cps-trkB-p7-end-to-end-and-repackage:T1
...
- **Task:** `T1` — Full coverage e2e against live tenant
- **Branch:** `feat/m365-cps-trkB`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkB-p7-end-to-end-and-repackage-T1
...
- **Task name:** Full coverage e2e against live tenant
- **Domain:** framework
- **Owner:** Phil Siniscalchi (Founder/Owner)
- **Dependencies:** none
...
Run all Track B parent phase smoke tests in sequence against live tenant; produce consolidated diagnostic.

Plan reference: `plan:m365-cps-trkB-p7-end-to-end-and-repackage:T1`. Branch: `feat/m365-cps-trkB`.
...
1. Per parent plan requirements: R4, R5
...
# 3. Validate
cd $UCP_ROOT && .venv/bin/python tests/integration/m365_cps_trkB_full_coverage.py
...
git add <files>
git commit -m "plan:m365-cps-trkB-p7-end-to-end-and-repackage:T1 — Full coverage e2e against live tenant"
```
...
- Validation command exits 0: `cd $UCP_ROOT && .venv/bin/python tests/integration/m365_cps_trkB_full_coverage.py`
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkB-p7-end-to-end-and-repackage:T1`
...
- **Validation result:** `cd $UCP_ROOT && .venv/bin/python tests/integration/m365_cps_trkB_full_coverage.py` exits 0
...
- Reference `plan:m365-cps-trkB-p7-end-to-end-and-repackage:T1` in commit message
