# Codex Execution Prompt — plan:m365-cps-trkB-p1-sharepoint-reads:T9
...
- **Task:** `T9` — Update YAML registry mirror
- **Branch:** `feat/m365-cps-trkB`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkB-p1-sharepoint-reads-T9
...
Plan reference: `plan:m365-cps-trkB-p1-sharepoint-reads:T9`. Branch: `feat/m365-cps-trkB`.
...
git add <files>
git commit -m "plan:m365-cps-trkB-p1-sharepoint-reads:T9 — Update YAML registry mirror"
```
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkB-p1-sharepoint-reads:T9`
...
- Reference `plan:m365-cps-trkB-p1-sharepoint-reads:T9` in commit message
