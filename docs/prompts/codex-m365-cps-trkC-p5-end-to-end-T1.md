# Codex Execution Prompt — plan:m365-cps-trkC-p5-end-to-end:T1

## Governance Lock (Read FIRST)

- `AGENTS.md` / `CLAUDE.md` (M365 repo and UCP repo)
- `docs/NORTH_STAR.md` (UCP) / `Operations/NORTHSTAR.md` (M365)
- `plans/m365-cps-trkC-p5-end-to-end/m365-cps-trkC-p5-end-to-end.md` (parent phase plan)
...
- **Plan:** `plan:m365-cps-trkC-p5-end-to-end`
- **Parent track:** `plan:m365-cps-trkC-truth-in-advertising`
- **Master plan:** `plan:m365-capability-pack-surface-remediation`
- **Task:** `T1` — E2E: invoke planned action returns not_yet_implemented
- **Branch:** `feat/m365-cps-trkC`

## Prompt Run Metadata

- Prompt version: v1.0
- Task ID: m365-cps-trkC-p5-end-to-end-T1
...
- **Task name:** E2E: invoke planned action returns not_yet_implemented
- **Domain:** framework
- **Owner:** Phil Siniscalchi (Founder/Owner)
- **Dependencies:** none
...
Live test: pick a known planned action; call via UCP; assert status_class == 'not_yet_implemented'.

Plan reference: `plan:m365-cps-trkC-p5-end-to-end:T1`. Branch: `feat/m365-cps-trkC`.
...
# 3. Validate
cd $UCP_ROOT && .venv/bin/python tests/integration/m365_planned_action_live.py
...
git add <files>
git commit -m "plan:m365-cps-trkC-p5-end-to-end:T1 — E2E: invoke planned action returns not_yet_implemented"
```
...
- Validation command exits 0: `cd $UCP_ROOT && .venv/bin/python tests/integration/m365_planned_action_live.py`
...
- [ ] Pre-commit green
- [ ] Commit message references `plan:m365-cps-trkC-p5-end-to-end:T1`
...
- **Validation result:** `cd $UCP_ROOT && .venv/bin/python tests/integration/m365_planned_action_live.py` exits 0
...
- Reference `plan:m365-cps-trkC-p5-end-to-end:T1` in commit message
