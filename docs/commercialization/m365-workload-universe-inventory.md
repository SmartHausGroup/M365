...
| Documents, notes, and workspace productivity | Word, Excel, PowerPoint, OneNote, Loop | Microsoft Graph includes Excel and OneNote; Microsoft 365 service descriptions cover Office apps; Conditional Access reference includes Loop | First bounded DOCX / XLSX / PPTX generation slice now implemented on top of files | `E2E` |
